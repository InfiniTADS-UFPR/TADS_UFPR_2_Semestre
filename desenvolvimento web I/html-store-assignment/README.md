...
- [x] Uma tabela (para o comparativo de especificações, por exemplo);
- [x] Um formulário simples para simular a compra de um dos produtos por cartão de
...
**Nota:** Eu até ia usar css, mas fiquei com preguiça
Talvez numa próxima versão, quem sabe
